...
public class JdbcSinkPerfTestOrig extends EasyMockSupport {
  ...
  public void setUp() throws IOException, SQLException {
    ...
    props.put("schema.registry.url", "REPLACE");
    ...
    connectClient.addConnector(NewConnectorDefinition.newBuilder()
            ...
            .withConfig("table.name.format", "PERFTEST_NESTEDVALUE")
            .withConfig("fields.whitelist", "ROOTRECORD_ROOTSTRING1, ROOTRECORD_ROOTSTRING2, "
                    + "ROOTRECORD_CHILDRECORD_CHILDSTRING1, ROOTRECORD_CHILDRECORD_CHILDSTRING2"
            )
            ...
            .withConfig("transforms", "flatten")
            .withConfig("transforms.flatten.type", "org.apache.kafka.connect.transforms.Flatten$Value")
            .withConfig("transforms.flatten.delimiter", "_")
            .build()
    );
    ...
    final InputStream flattened_key_avro_file = JdbcSinkPerfTestOrig.class.getClassLoader()
            .getResourceAsStream("avro/key.avsc");
    final InputStream flattened_value_avro_file = JdbcSinkPerfTestOrig.class.getClassLoader()
            .getResourceAsStream("avro/value_wo_array.avsc");
  ...
  public void performanceTestSinkConnectorAvro() throws IOException, SQLException {
    ...
    int throughputPerSecond = 2;
    int iterationDurationSeconds = 2;
    long messagesSent = 0;
