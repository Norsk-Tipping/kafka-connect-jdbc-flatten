...
/**
 * A {@link DatabaseDialect} for NetezzaSQL.
 */
public class NetezzaSqlDatabaseDialect extends GenericDatabaseDialect {
  ...
  public static class Provider extends SubprotocolBasedProvider {
    public Provider() {
      super(NetezzaSqlDatabaseDialect.class.getSimpleName(), "netezza-driver");
    }
  ...
  public List<String> buildAlterTable(
    ...
    builder.append(" ");
    builder.append("ADD ");
    //Netezza needs explicitly COLUMN in the statement
  ...
  protected String getSqlType(SinkRecordField field) {
    ...
    switch (field.schemaType()) {
      ...
      case BOOLEAN:
        return "BOOLEAN";
      //Netezza doesn't have TEXT so VARCHAR(500) is used
      case STRING:
        return "VARCHAR(500)";
      case BYTES:
        return "BYTEA";
